...
# 2047 - это не простое число, в методичке ошибка.
# Рядом стоящее простое число, которое при деление 4 дают остаток 3: 2063
class BBSRandom:
    def __init__(self, seed: int, p: int = 2063, q: int = 8191):
