...
1) Системные переменные -> Имя переменной: JAVA_HOME, Значение переменной: C:\Program Files\Java\jdk-22 ;
2) В переменную Path добавить: %JAVA_HOME%\bin
3) Перейти: File -> Project Structure -> Project -> SDK - выбрать установленный JDK -> Apply -> OK
